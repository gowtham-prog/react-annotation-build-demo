...
var Annotation = /*#__PURE__*/function (_Component) {
  ...
  function Annotation() {
    ...
    _defineProperty(_assertThisInitialized(_this), "setInnerRef", function (el) {
      _this.container = el;
      _this.props.ref(el); // Call the ref callback of the parent component first
      _this.props.relativeMousePos.ref(el); // Call the relativeMousePos.ref callback second
    });
